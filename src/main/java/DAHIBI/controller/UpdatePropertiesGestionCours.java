...
;
	...
	public static PropertiesConfiguration main1(@RequestBody Constants cns)
			throws org.apache.commons.configuration.ConfigurationException, ConfigurationException {
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"C://configrepo//localconfig//gestionDesCours-production.properties");
		properties.setProperty("prefix", cns.getPrefix());
		properties.setProperty("suffix", cns.getSuffix());
		properties.setProperty("message", cns.getMessage());
		properties.setProperty("username", cns.getUsername());
	...
	public static PropertiesConfiguration main2(@RequestBody Constants cns)
			throws org.apache.commons.configuration.ConfigurationException, ConfigurationException {
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"C://configrepo//localconfig//gestionDesCours-developpement.properties");
		properties.setProperty("prefix", cns.getPrefix());
		properties.setProperty("suffix", cns.getSuffix());
		properties.setProperty("message", cns.getMessage());
		properties.setProperty("username", cns.getUsername());
	...
	@PostMapping("/Test")
	public static PropertiesConfiguration main3(@RequestBody Constants cns)
			throws org.apache.commons.configuration.ConfigurationException, ConfigurationException {
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"C://configrepo//localconfig//gestionDesCours-test.properties");
		properties.setProperty("prefix", cns.getPrefix());
		properties.setProperty("suffix", cns.getSuffix());
		properties.setProperty("message", cns.getMessage());
		properties.setProperty("username", cns.getUsername());
