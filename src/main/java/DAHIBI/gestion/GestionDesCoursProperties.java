...
public class GestionDesCoursProperties {

	@GetMapping("/DefaultProfile")
	public static Map<String, String> main(String[] args) {
		String propertiesFilename = "C://configrepo//localconfig//gestionDesCours.properties";
	...
	public static Map<String, String> main1(String[] args) {
		String propertiesFilename = "C://configrepo//localconfig//gestionDesCours-developpement.properties";
		Map<String, String> properties = new HashMap<>();
	...
	public static Map<String, String> main2(String[] args) {
		String propertiesFilename = "C://configrepo//localconfig//gestionDesCours-test.properties";
		Map<String, String> properties = new HashMap<>();
	...
	public static Map<String, String> main3(String[] args) {
		String propertiesFilename = "C://configrepo//localconfig//gestionDesCours-production.properties";
		Map<String, String> properties = new HashMap<>();
